...
type UserSocialProfile_t struct {
	IntercomType string `json:"type"`
...
type UserList_t struct {
	...
	Pages        UserPages_t `json:"pages"`
	Users        []User_t    `json"users"`
} //UserList_t

type UserPages_t struct {
